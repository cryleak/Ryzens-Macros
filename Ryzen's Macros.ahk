...
if (SmoothEWO = 1) {
sendinput {%EWOLookBehindKey% down}{lbutton up}{rbutton up}{enter down}{g down}
...
sendinput {%EWOLookBehindKey% down}{lbutton up}{rbutton up}{enter down}{g down}
send {%InteractionMenuKey%}{up}
sendinput {wheelup}{%EWOSpecialAbilitySlashActionKey% down}{enter up}
send {enter}
sendinput {%EWOLookBehindKey% up}{< up}{g up}{%EWOSpecialAbilitySlashActionKey% up}
sleep 25
send {%InteractionMenuKey%}
